...
public class Loot : MonoBehaviour {
	...
	public void Init(LootTypes knd, MonoBehaviour parent){
		kind = knd;
		Debug.Log ("Assets/Sprites/Projectiles/Resource" + knd.ToString () + ".png");
		sprite = AssetDatabase.LoadAssetAtPath<Sprite>("Assets/Sprites/Loot/Resource" + knd.ToString() + ".png");
		par = parent;
